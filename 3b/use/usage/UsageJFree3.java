...
public class UsageJFree3 {
	...
	public static void trigger() throws CloneNotSupportedException {
        ...
        System.out.println(s2.getMaxY());
        System.out.println(s2.getMinY());
	}
 
	public static void main(String[] args) throws CloneNotSupportedException {
		UsageJFree3 chartCreator = new UsageJFree3();
